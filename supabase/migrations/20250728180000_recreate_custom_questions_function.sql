...
-- Drop the new function signature if it exists
DROP FUNCTION IF EXISTS public.get_custom_simulado_questions(uuid, text, integer, text[], difficulty_level[], uuid[], boolean);
